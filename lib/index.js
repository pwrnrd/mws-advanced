...
class MwsAdvanced {
    ...
    constructor(...args) {
        ...
        this.registerDestination = this.registerDestination.bind(this);
        this.deregisterDestination = this.deregisterDestination.bind(this);
    ...
    registerDestination(...params) {
        const { registerDestination } = require('./helpers/subscriptions');
        return registerDestination(this)(...params);
    }

    static registerDestination(...params) {
        return staticMws.registerDestination(...params);
    }

    deregisterDestination(...params) {
        const { deregisterDestination } = require('./helpers/subscriptions');
        return deregisterDestination(this)(...params);
    }

    static deregisterDestination(...params) {
        return staticMws.deregisterDestination(...params);
    }
    ...
    static createSubscription(...params) {
        return staticMws.createSubscription(...params);
    }

    deleteSubscription(...params) {
        const { deleteSubscription } = require('./helpers/subscriptions');
        return deleteSubscription(this)(...params);
    }

    static deleteSubscription(...params) {
        return staticMws.deleteSubscription(...params);
    }
